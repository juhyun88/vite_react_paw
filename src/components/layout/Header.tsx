            ...
            <div className="flex justify-between items-stretch ">
                    ...
                    {menuData.map((menu, index) => (
                        <li key={index} className="relative text-center px-[33px]  py-0 h-full transition-all duration-300 ease-in-out">
                            ...
                            <ul className="absolute text-white p-0 m-0 left-0 right-0 top-100  py-[18px]">
                                ...
                                <li key={idx}>
                                    <Link to={link.path} className='text-white whitespace-nowrap py-[10px] block'>{link.name}</Link>
                                </li>
                                ))}
                            </ul>
                        </li>
                ...
                <div className="flex items-center ">
                    <ul className="reservation flex justify-end items-center mb-0 p-0 gap-[30px]">
                        ...
                        <Link to="/reservation" className="reservation-button flex items-center text-white gap-[15px] py-[10px] px-[20px] bg-[#8087A04D] rounded-[80px]">
