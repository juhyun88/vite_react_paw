...
const QuickMenu:React.FC = () =>{
    ...
    return (
        ...
        <div className="hidden lg:flex fixed quick_Menu bottom-[171px] right-[100px] z-50 flex-col gap-3 ">
          ...
          {isExpanded && (
            ...
            <a href="#top" className= 'w-[72.3px] h-[72.3px] p-[16.87px] flex items-center gap-[24.1px] bg-quickcolor rounded-full justify-center shadow-xl' >
