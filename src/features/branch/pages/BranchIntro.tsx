    ...
    return (
      <div className={`${className} flex justify-center bg-[#F7F7F5]`}>
        <div className="w-[1280px] mx-auto">
          {/* Hero Section */}
          <section className="flex flex-col justify-center text-center md:py-[100px] py-[80px]">
            <h1 className="text-[50px] md:text-[80px] text-[#3A3A3A] font-[700] md:mb-[100px] mb-[80px]">파우펙트 웨이브 본점</h1>
  
            <div className="flex flex-col md:flex-row items-between overflow-hidden text-left">
              {/* 텍스트 영역 */}
              <div className="flex-1 px-6 space-y-6">
                <h2 className="text-xl md:text-[35px] font-[600] leading-snug md:mb-[0px] mb-[80px]">
                  하늘과 별이 마주하고 자연과 함께<br className="hidden md:block" />
                  어우러지는 친환경적인 파우펙트<br className="hidden md:block" />
                  웨이브 서울지점입니다.
                </h2>
                <p className="md:text-[25px] font-[300] md:pb-[0px] pb-[80px]">
               ...
               {/* 지점 정보 */}
                    ...
                    <div className="md:w-[610px] md:h-[440px]">
                        ...
                        alt="지점 건물"
                        className="w-full h-full object-cover rounded-[83px] mt-[20px]"
                        />
                    </div>
