  ...
  return (
    <div className="bg-[#F7F7F5]">
      ...
      <section className="text-center px-4 py-[80px] md:py-[100px]">
        <h1 className="text-[32px] md:text-[80px] text-[#3A3A3A] font-[700] mb-[40px] md:mb-[100px] leading-tight">
          파우펙트 웨이브의 기부 캠페인
        </h1>
        ...
        <div className="flex flex-col items-center gap-8 md:gap-10 max-w-[1280px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center">
            ...
            <blockquote className="mt-4 md:mt-0 md:w-1/2 text-center md:text-left">
              <span className="block font-ice text-[28px] md:text-[45.71px] mb-[40px] md:mb-[73px]">
                "떠난 아이의 이름으로,<br /> 또하나의 생명을 지켜주세요"
              </span>
              <span className="font-hakgyo text-base md:text-[20px] font-light300 leading-relaxed">
      ...
      <section className="bg-[#F7F7F5] pt-[60px] md:pt-[100px] px-4">
        ...
        <div className="w-full flex justify-center">
          <div
            className="w-full md:w-[1280px] h-[500px] md:h-[1230px] bg-no-repeat bg-center bg-cover flex items-center justify-center"
            style={{
