...
function IntroSection() {
  ...
  <div className="max-w-screen-xl mx-auto grid grid-cols-2 grid-rows-3 gap-16 px-4" id="ehwave_love">
    ...
    <div className="relative w-full flex justify-center items-center">
      ...
      <div className="absolute top-0 left-0">
              <svg  className="animate-rotate45" xmlns="http://www.w3.org/2000/svg" width="605" height="605" viewBox="0 0 605 605" fill="none">
          ...
          {/* 사랑 - 텍스트 */}
            ...
            <p className="text-[20px] md:text-[24px] leading-relaxed text-center">
                <span className="font-bold text-[#754C43] text-[45px]">사랑</span>
                <span className="text-[45px]">은 가족의 일원으로서 사랑과 보살핌을 받으며 소중한 시간을 <br />함께한 존재로써</span>
                <span className=" text-[#754C43] text-[45px]"> 사랑의 마음</span>
                <span className="text-[45px]">으로 <br /></span>
                <span className="text-[#754C43] text-[45px]">서로 메세지</span>
                <span className="text-[45px]">를 나누는 시간과<br /> 되새기는 시간을 의미합니다.</span>
            </p>
            </div>
           ...
           {/* 인사 - 텍스트 */}
            <div className="flex items-center justify-center text-center md:text-left">
            <p className="text-[20px] md:text-[24px] leading-relaxed text-center">
                <span className="font-bold text-[#754C43] text-[45px]">인사</span>
                <span className="text-[45px]">는 마지막 여행을 떠나는<br /> 반려동물에게 단순한 <br /></span>
                <span className=" text-[#754C43] text-[45px]">작별 인사</span>
                <span className="text-[45px]">가 아닌 반려동물의 <br />
                <span className=" text-[#754C43] text-[45px]">삶과 마지막 여행</span>에 대한<br /> 마음을 담았습니다.</span>
            </p>
            </div>
        ...
        />
        <div className="absolute top-0 left-0">
              <svg className="animate-rotate40" xmlns="http://www.w3.org/2000/svg" width="608" height="450" viewBox="0 0 608 450" fill="none" >
           ...
           {/* 추억 - 이미지 */}
             <div className="relative w-full flex justify-center items-center">
                ...
                />
             <div className="absolute top-0 left-0">
              <svg className="animate-pop" xmlns="http://www.w3.org/2000/svg" width="687" height="589" viewBox="0 0 687 589" fill="none">
           ...
           {/* 추억 - 텍스트 */}
            <div className="flex items-center justify-center text-center md:text-left">
            <p className="text-[20px] md:text-[24px] leading-relaxed text-center">
                <span className="font-bold text-[#754C43] text-[45px] ">추억</span>
                <span className="text-[45px]">은 반려동물의<br /> 처음과 끝을 함께하며 <br />
                <span className="text-[#754C43] text-[45px]">많은 추억을 공유</span>했던 <br />소중한 시간들을 
                <span className="text-[#754C43] text-[45px]">기념</span>하는<br /> 의미를 담았습니다.</span>
            </p>
            </div>
